...
```bash
curl -X GET "https://api.apiverve.com/v1/captchagenerator?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/captchagenerator](https://docs.apiverve.com/ref/captchagenerator)

---

## Use Cases

Common use cases for the Captcha Generator API:
