...
```gradle
dependencies {
    implementation 'com.github.apiverve:captchagenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.captchagenerator.CaptchaGeneratorAPIClient;
import com.apiverve.captchagenerator.APIResponse;
import com.apiverve.captchagenerator.APIException;

// Initialize the client
CaptchaGeneratorAPIClient client = new CaptchaGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/captchagenerator](https://docs.apiverve.com/ref/captchagenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/captchagenerator](https://docs.apiverve.com/ref/captchagenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/captchagenerator-api/issues)
